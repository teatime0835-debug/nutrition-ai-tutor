...
#### 3. 청소년 맞춤 영양 코칭
- 현재 식단의 긍정적인 점
- 현재 식단에서 부족한 영양소 또는 과잉된 영양소 또는 건강에 유익하지 않다고 보고된 메뉴나 조리법 등 개선이 필요한 점
- 부족한 점이 있다면 개선을 위해 '다음 식사'에 추천하는 식품이나 메뉴 중 학교 급식 또는 가정에서 가능한 메뉴 위주로 2가지 제안  
- 만약 부족한 점이 없다면 현재 식단의 긍정적인 점을 살린 또 다른 메뉴를 1가지 제안
- 앞서 분석한 내용과 관련하여 청소년기 영양 섭취의 중요성에 대한 조언
